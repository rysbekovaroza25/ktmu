...
import com.example.ktmuyoklama.view.teacherPage.home.MyLessonListFragment;
import com.example.ktmuyoklama.view.teacherPage.home.MyLessonStudentsListFragment;

import org.jetbrains.annotations.NotNull;

import java.util.List;

public class MyLessonListAdapter extends RecyclerView.Adapter<MyLessonListAdapter.ViewHolder> {
    private List<MyLessonList> dataList;
    private Context context;
    public MyLessonListFragment myLessonListFragment;
    public static int kod_id = 0;
    public static String lessonKod;

    public MyLessonListAdapter(Context context, List<MyLessonList> listData) {
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        holder.imageButton.setOnClickListener(view -> {
            ...
            Fragment fragment = new MyLessonStudentsListFragment();
    ...
    public static void setKod_id(int kod_id) {
        MyLessonListAdapter.kod_id = kod_id;
    }
    ...
    public static void setLessonKod(String lessonKod) {
        MyLessonListAdapter.lessonKod = lessonKod;
    }
}
