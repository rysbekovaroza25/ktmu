...
import com.example.ktmuyoklama.view.teacherPage.facereconition.FaceCameraFragment;

import org.jetbrains.annotations.NotNull;

import java.util.List;

public class YoklamaFaceAdapter extends RecyclerView.Adapter<YoklamaFaceAdapter.ViewHolder> {
    private List<MyLessonList> dataList;
    private Context context;
    public static int kod_id = 0;
    public static String lessonKod;

    public YoklamaFaceAdapter(Context context, List<MyLessonList> listData) {
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        holder.imageButton.setOnClickListener(view -> {
            ...
            Fragment fragment = new FaceCameraFragment();
